<html>
<head>
<title>Task Management | Add</title>
</head>
...
<tr>
<td>Task Name : </td>
<td><input type='text' size="50" name='taskName' placeholder="Task Name" required/></td>
</tr> 
<td>Task Description : </td>
<td><input type='text' size="50" name='taskDesc' placeholder="Task Description" required/></td>
</tr> 
<td>Task Priority : </td>
<td><select id="taskPriority" name="taskPriority">
...
<td>Task Status : </td>
<td><select id="taskStatus" name="taskStatus">
...
<td> <select name="cars" id="cars">
    <option value="volvo">Low Priority</option>
    <option value="saab">Medium Priority</option>
    <option value="opel">High Priority</option>
  </select>
  </td>
</tr>-->
